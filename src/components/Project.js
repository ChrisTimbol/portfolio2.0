...
export default function Project({ title, description, github, website, thumbnail }) {
    return (
        <div className="border border-cyan-700 w-full h-full p-4 bg-slate-950 rounded-lg shadow-md shadow-cyan-900 transition duration-300 group hover:shadow-2xl relative flex flex-col">
