...
export const RocketIcon = () => (
  <svg className="w-6 h-6 hover:text-cyan-500  dark:text-white text-white hover:text-cyan-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
...
export const CodeBrackets = () => (
  <svg className="w-6 h-6  text-cyan-100  hover:text-cyan-500  dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
    <path
...
export const MagicWand = () => (
  <svg className="w-6 h-6 text-white hover:text-cyan-500  dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 21">
    <path
      stroke="currentColor"
      strokeLinecap="round"
...
export const People = () => (
  <svg
    className="w-6 h-6  dark:text-white  hover:text-cyan-500"
    aria-hidden="true"
...
export const GithubMediaIcon = () => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className="h-6 w-6 md:h-8  lg:w-10  text-slate-500 hover:text-cyan-500"
    fill="currentColor"
    viewBox="0 0 24 24"
  >
    <path
...
export const LinkedInMediaIcon = () => (
  <svg className="w-6 h-8  md:w-8   lg:w-8  text-slate-500 hover:text-cyan-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 15 15">
...
export const GmailMediaIcon = () => (
  <svg className="w-6 h-6  md:w-8  lg:h-10    text-slate-500 hover:text-cyan-500 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 19">
...
export const InstagramMediaIcon = () => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className="h-6 w-6  md:w-8  lg:h-10   text-slate-500 hover:text-cyan-500"
    fill="currentColor"
    viewBox="0 0 24 24"
  >
